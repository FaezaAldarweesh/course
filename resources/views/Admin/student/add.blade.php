...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">الطلاب</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ اضافة طالب</span>
        </div>
    </div>
</div>
    ...
    <div class="card-body">
        ...
        <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"  enctype="multipart/form-data"
            ...
            <div class="row mg-b-20">
                    ...
                    <div class="parsley-input col-md-6" id="fnWrapper">
                        <label> المسكن :</label>
                        <input class="form-control form-control-sm mg-b-20" name="location" value="" required type="text">
                    </div>

                    <div class="parsley-input col-md-6" id="fnWrapper">
                        <label> كلمة السر :</label>
                        <input class="form-control form-control-sm mg-b-20" name="password" value="" required type="password">
                    </div>
                </div>
